...
class TechnicalQuizSystem extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equals("Result")) {
            ...
            JOptionPane.showMessageDialog(this,"Wrong answer=" + (10-count) );
            System.exit(0);
        }
    }
    ...
    public static void main(String s[]) {
        new TechnicalQuizSystem("Quiz System");
    }
